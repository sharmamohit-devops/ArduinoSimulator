  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        'component': '0 4px 6px -1px rgb(0 0 0 / 0.1), 0 2px 4px -2px rgb(0 0 0 / 0.1)',
        'drag': '0 10px 15px -3px rgb(0 0 0 / 0.1), 0 4px 6px -4px rgb(0 0 0 / 0.1)',
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
      ...
      animation: {
        ...
        "led-on": "led-on 1s ease-in-out infinite",
      },
    },
  },
